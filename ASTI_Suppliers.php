...
class ASTI_Suppliers extends Company
{
    public $new_schema = true;
    public $module_dir = 'ASTI_Suppliers';
    public $object_name = 'ASTI_Suppliers';
    public $table_name = 'asti_suppliers';
